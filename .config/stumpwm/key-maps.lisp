...
(setf *top-map*
  (let ((m (stumpwm:make-sparse-keymap)))
    ...
    (define-key m (kbd "s-)")    "resize  0  25")
    (define-key m (kbd "s-(")    "resize  0 -25")
    ...
    (define-key m (kbd "s-E")    "exec eject")
    ...
    (define-key m (kbd "s-F1")   "dump-group-to-file /home/milo/.config/stumpwm/storage/group_1")
    (define-key m (kbd "s-F2")   "dump-group-to-file /home/milo/.config/stumpwm/storage/group_2")
    (define-key m (kbd "s-F3")   "dump-group-to-file /home/milo/.config/stumpwm/storage/group_3")
    (define-key m (kbd "s-F4")   "dump-group-to-file /home/milo/.config/stumpwm/storage/group_4")
    (define-key m (kbd "s-F5")   "dump-group-to-file /home/milo/.config/stumpwm/storage/group_5")
    (define-key m (kbd "s-F6")   "dump-group-to-file /home/milo/.config/stumpwm/storage/group_6")
    (define-key m (kbd "s-F8")   "dump-window-placement-rules /home/milo/.config/stumpwm/storage/placement_rules")
    (define-key m (kbd "s-F9")   "dump-screen-to-file /home/milo/.config/stumpwm/storage/screen_data")
    (define-key m (kbd "F1")     "restore-from-file /home/milo/.config/stumpwm/storage/group_1")
    (define-key m (kbd "F2")     "restore-from-file /home/milo/.config/stumpwm/storage/group_2")
    (define-key m (kbd "F3")     "restore-from-file /home/milo/.config/stumpwm/storage/group_3")
    (define-key m (kbd "F4")     "restore-from-file /home/milo/.config/stumpwm/storage/group_4")
    (define-key m (kbd "F5")     "restore-from-file /home/milo/.config/stumpwm/storage/group_5")
    (define-key m (kbd "F6")     "restore-from-file /home/milo/.config/stumpwm/storage/group_6")
