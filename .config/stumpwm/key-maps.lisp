...
(defvar *frequent-map*
  (let ((m (make-sparse-keymap)))
    ...
    (dk m (kbd "B") "exec display -window root -resize 1366x768! ~/foto/wall/1366x768_Dizorb_Landscape_HD_Wallpaper.png")
...
(setf *top-map*
  (let ((m (make-sparse-keymap)))
    ...
    (dk m (kbd "s-9")    "quiet-resize 0 -15")
    (dk m (kbd "s-0")    "quiet-resize 0  15")
