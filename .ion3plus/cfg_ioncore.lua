...
defbindings("WMPlex.toplevel", {
    ...
    kpress(ALTMETA.."F2", "ioncore.exec_on(_, URXVT or 'urxvt')"),

    bdoc("Query for Lua code to execute."),
    kpress(META.."F2", "mod_query.query_lua(_)"),
    ...
    kpress(ALTMETA.."F5", 
             "mod_query.query_editfile(_, ':vim $1')"),

    bdoc("Query for file to view."),
    kpress(ALTMETA.."F6", 
             "mod_query.query_runfile(_, ':3view $1')"),
...
defbindings("WFrame", {
    ...
    kpress(META..LEFT.."+Shift", "WFrame.dec_index(_, _sub)", "_sub:non-nil"),
    kpress(META..RIGHT.."+Shift", "WFrame.inc_index(_, _sub)", "_sub:non-nil"),
