...
ioncore.defshortening("(.*) - firefox(<[0-9]+>)", "$1$2$|$1$<...$2")
ioncore.defshortening("(.*) - firefox", "$1$|$1$<...")
ioncore.defshortening("(.*) - uzbl-browser(<[0-9]+>)", "$1$2$|$1$<...$2")
ioncore.defshortening("(.*) - uzbl-browser", "$1$|$1$<...")
