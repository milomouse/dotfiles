...
" Created:      2011-xx-xx
" Last Change:  2013-05-05
" Colorful yet muted
" Recommended for 256-color console
...
if ( &t_Co >= 255 || $TERM =~? "256color" )
  ...
  hi StatusLine     term=none cterm=none ctermfg=234  ctermbg=239
  ...
  hi Title          term=none cterm=none ctermfg=248  ctermbg=none
  ...
  hi VertSplit      term=none cterm=none ctermfg=236  ctermbg=239
...
"else " for the linux console (and other non-256-color terminal emulators)
